        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="check_in_start" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="check_in_end" class="form-control" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="check_out_start" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="check_out_end" class="form-control" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Jam Masuk Awal<span class="required-form-star">*</span></label>
                        <input type="time" name="saturday_check_in_start" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Jam Masuk Akhir<span class="required-form-star">*</span></label>
                        <input type="time" name="saturday_check_in_end" class="form-control" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Jam Keluar Awal<span class="required-form-star">*</span></label>
                        <input type="time" name="saturday_check_out_start" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Jam Keluar Akhir<span class="required-form-star">*</span></label>
                        <input type="time" name="saturday_check_out_end" class="form-control" required>
                    </div>
                </div>
            </div>
...
$("#add-time").submit(function(event) {
    ...
    $.ajax({
        url: '{!! url("/pengaturan-waktu-pegawai/store/") !!}',
        type: "POST",
        data: formData,
        cache: false,
        processData: false,
